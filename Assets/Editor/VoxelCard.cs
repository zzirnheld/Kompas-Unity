...
public partial class VoxelCard : VoxelCardBase
{
    ...
    public (Texture2D, Texture2D) GenerateTexture()
    {
        ...
        var newTextures = VoxelCardTextureBuilder.BuildTexture(mat.GetTexture(MainTextureName) as Texture2D, mat.GetTexture(MainMetalnessName) as Texture2D, MyParams, rebuild);
