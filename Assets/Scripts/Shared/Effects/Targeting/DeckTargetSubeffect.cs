...
public class DeckTargetSubeffect : CardTargetSubeffect
{
    public override void Resolve()
    {
        ...
        if (!parent.thisCard.game.ExistsDeckTarget(cardRestriction, parent.EffectController))
        {
        ...
        parent.EffectController.ServerNotifier.GetDeckTarget(parent.thisCard, cardRestriction, parent.X);
