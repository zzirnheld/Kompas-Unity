...
namespace KompasCore.Networking
{
    public class AttachCardPacket : Packet
    {
        ...
        public override Packet GetInversion(bool known)
        {
            ...
            else return new AddCardPacket(cardId, json, CardLocation.Board, controllerIndex, x, y, attached: true, known: true, invert: true);
        }
    }
}
...
namespace KompasClient.Networking
{
    public class AttachCardClientPacket : AttachCardPacket, IClientOrderPacket
    {
        public void Execute(ClientGame clientGame)
        {
            ...
            var attachedTo = clientGame.BoardController.GetCardAt((x, y));
