...
namespace KompasServer.Cards
{
    public class ServerGameCard : GameCard
    {
        ...
        {
            var attachedContext = new TriggeringEventContext(game: ServerGame, mainCardBefore: augment, secondaryCardBefore: this,
                space: Position, stackableCause: stackSrc, player: stackSrc?.Controller ?? Controller);
            var augmentedContext = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, secondaryCardBefore: augment,
                space: Position, stackableCause: stackSrc, player: stackSrc?.Controller ?? Controller);
        ...
        protected override void Detach(IStackable stackSrc = null)
        {
            ...
            var context = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, secondaryCardBefore: formerlyAugmentedCard,
        ...
        public override bool Remove(IStackable stackSrc = null)
        {
            ...
            var context = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, stackableCause: stackSrc, player: player);
            ...
            var leaveContexts = cardsThisLeft.Select(c =>
                new TriggeringEventContext(game: ServerGame, mainCardBefore: this, secondaryCardBefore: c, stackableCause: stackSrc, player: player)).ToArray();
        ...
        {
            var context = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, stackableCause: stackSrc, player: stackSrc?.Controller);
        ...
        {
            if (n == N) return;
            var context = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, stackableCause: stackSrc, player: stackSrc?.Controller, x: n - N);
        ...
        public override void SetE(int e, IStackable stackSrc = null, bool onlyStatBeingSet = true)
        {
            if (e == E) return;
            int oldE = E;
            var context = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, stackableCause: stackSrc, player: stackSrc?.Controller, x: e - E);
        ...
        {
            if (s == S) return;
            var context = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, stackableCause: stackSrc, player: stackSrc?.Controller, x: s - S);
        ...
        {
            if (w == W) return;
            var context = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, stackableCause: stackSrc, player: stackSrc?.Controller, x: w - W);
        ...
        {
            if (c == C) return;
            var context = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, stackableCause: stackSrc, player: stackSrc?.Controller, x: c - C);
        ...
        {
            if (a == A) return;
            var context = new TriggeringEventContext(game: ServerGame, mainCardBefore: this, stackableCause: stackSrc, player: stackSrc?.Controller, x: a - A);
