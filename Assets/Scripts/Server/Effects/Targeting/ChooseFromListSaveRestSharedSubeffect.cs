...
{
    public class ChooseFromListSaveRestSharedSubeffect : ChooseFromListSubeffect
    {
        ...
        protected override bool IsValidTarget(GameCard card) => base.IsValidTarget(card) && chooseRestriction.IsValidCard(card, CurrentContext);
