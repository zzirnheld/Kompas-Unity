...
namespace KompasServer.Effects.Subeffect.Hanging
{
    public class NegateSubeffect : HangingEffectSubeffect
    {
        ...
        protected override IEnumerable<HangingEffect> CreateHangingEffects()
        {
            ...
            var tempNegation = new Negation(serverGame: ServerGame,
        ...
        public class Negation : HangingEffect
        {
            private readonly GameCard target;
            private readonly ServerSubeffect source;
            private readonly bool negated;

            public Negation(ServerGame serverGame, TriggerRestriction triggerRestriction, string endCondition,
